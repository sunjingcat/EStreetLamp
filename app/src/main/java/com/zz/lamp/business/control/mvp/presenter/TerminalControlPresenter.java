...
public class TerminalControlPresenter extends MyBasePresenterImpl<Contract.IGetTerminalControlView> implements Contract.IsetTerminalControlPresenter {
    ...
    @Override
    public void realTimeCtrlLine(String id,Map<String, Object> params,Integer[] ids) {
        RxNetUtils.request(getCApi(ApiService.class).realTimeCtrlLine(id,params,ids), new RequestObserver<JsonT>(this) {
            @Override
