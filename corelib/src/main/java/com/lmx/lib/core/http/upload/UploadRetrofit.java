package com.lmx.lib.core.http.upload;


import android.app.Dialog;

import com.lmx.lib.core.http.http.RetrofitClient;
import com.lmx.lib.core.http.interceptor.Transformer;
...
public class UploadRetrofit {
    ...
    public UploadRetrofit(String baseUrl) {
    ...
    public static UploadRetrofit getInstance(String url) {

        if (instance == null) {
            synchronized (RetrofitClient.class) {
                if (instance == null) {
                    instance = new UploadRetrofit(url);
                }
            }
