package com.lmx.lib.core.http.http;

import android.os.Environment;
import android.text.TextUtils;


import com.lmx.lib.core.http.interceptor.AddCookiesInterceptor;
import com.lmx.lib.core.http.interceptor.CacheInterceptor;
import com.lmx.lib.core.http.interceptor.CommonParamInterceptor;
import com.lmx.lib.core.http.interceptor.HeaderInterceptor;
import com.lmx.lib.core.http.interceptor.ReceivedCookiesInterceptor;
import com.lmx.lib.core.http.log.JsonLogger;
...
public class SingleRxHttp {
    ...
    public String getBaseUrl() {
        return TextUtils.isEmpty(baseUrl) ? RetrofitClient.getInstance().getRetrofit().baseUrl().toString() : baseUrl;
    }
    ...
    public SingleRxHttp addParams(Map<String, Object> params) {
    ...
    public <K> K createSApi(Class<K> cls) {
        Retrofit.Builder builder = getSingleRetrofitBuilder();
    ...
    public Retrofit.Builder getSingleRetrofitBuilder() {
        ...
        if (TextUtils.isEmpty(baseUrl)) {
            baseUrl = RetrofitClient.getInstance().getRetrofit().baseUrl().toString();
        }
    ...
    private OkHttpClient.Builder getSingleOkHttpBuilder() {
        ...
        singleOkHttpBuilder.addInterceptor(new CommonParamInterceptor(commonParams));
        ...
        if (isShowLog) {
            HttpLoggingInterceptor loggingInterceptor = new HttpLoggingInterceptor(new JsonLogger());
